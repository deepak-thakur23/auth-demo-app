...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__services_admin_auth_guard_service__ = __webpack_require__("./src/app/services/admin-auth-guard.service.ts");
...
function authHttpServiceFactory(http, options) {
    return new __WEBPACK_IMPORTED_MODULE_18_angular2_jwt__["AuthHttp"](new __WEBPACK_IMPORTED_MODULE_18_angular2_jwt__["AuthConfig"]({}), http, options);
}
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__angular_router__["a" /* RouterModule */].forRoot([
                ...
                { path: 'admin', component: __WEBPACK_IMPORTED_MODULE_13__admin_admin_component__["a" /* AdminComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__services_auth_guard_service__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_17__services_admin_auth_guard_service__["a" /* AdminAuthGuard */]] },
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_17__services_admin_auth_guard_service__["a" /* AdminAuthGuard */],
...
function fakeBackendFactory(backend, options) {
    //for admin=true;
    var token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkRlZXBhayBUaGFrdXIiLCJhZG1pbiI6dHJ1ZX0.5aWRqfrp-UdhnZCZ-5R1YEZkw2Mw36X-trXesQ26VbA';
    //for admin=false;
        ...
        setTimeout(function () {
            ...
            if (connection.request.url.endsWith('/api/orders') &&
                ...
                if (connection.request.headers.get('Authorization') === 'Bearer ' + token) {
                    connection.mockRespond(new __WEBPACK_IMPORTED_MODULE_0__angular_http__["Response"](new __WEBPACK_IMPORTED_MODULE_0__angular_http__["ResponseOptions"]({ status: 200, body: [1, 2, 3, 4] })));
                }
                else {
...
var OrderService = (function () {
    function OrderService(authHttp, http) {
...
OrderService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3_angular2_jwt__["AuthHttp"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angular2_jwt__["AuthHttp"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_http__["Http"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_http__["Http"]) === "function" && _b || Object])
], OrderService);
